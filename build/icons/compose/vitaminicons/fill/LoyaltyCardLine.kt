...
public val FillGroup.LoyaltyCardLine: ImageVector
    get() {
        if (_loyaltyCardLine != null) {
            return _loyaltyCardLine!!
        }
        _loyaltyCardLine = Builder(name = "LoyaltyCardLine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _loyaltyCardLine: ImageVector? = null
